...
public class CalculatorController implements Initializable
{
    ...
    void buttonDropClick(ActionEvent event) {
        if (currentVal.isEmpty()) { // replaced all relevant statement with .isEmpty
            if (!rpn.drop()) {
    ...
    void buttonEnterClick(ActionEvent event) {
        try {
            if (currentVal.isEmpty()) { // if nothing in queue copy top of stack
    ...
    void buttonPlusClick(ActionEvent event) {
        checkCursor();
        if (!rpn.add())
            displayErrorMessage("ERROR: Insufficient Operands for Add");
        else
            updateDisplay();
    }
    ...
    void buttonMinusClick(ActionEvent event) {
        checkCursor();
        if (!rpn.subtract())
            displayErrorMessage("ERROR: Insufficient Operands for Subtract");
        else
            updateDisplay();
    }
    ...
    void buttonDivideClick(ActionEvent event) throws Exception {
        ...
        try {
            if (!rpn.divide())
                displayErrorMessage("ERROR: Insufficient Operands for Divide");
            else
                updateDisplay();
